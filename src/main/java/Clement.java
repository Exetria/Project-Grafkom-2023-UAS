    ...
    public void init()
    {
        ...
        spheres.add(new Sphere
                (
                        ...
                        new ArrayList<>(),
                        new Vector4f(1f, 1f, 0.87f, 1.0f), new ArrayList<>(),
                        "C:\\Users\\Clement\\Intellij\\Project-Grafkom-2023-UAS\\resources\\objects\\Clement\\matahari.obj"
                )
        );
        spheres.get(0).translateObject(-5f, 10f, 20f);
        ...
        spheres.add(new Sphere
                (
                        Arrays.asList
                                (new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER), new ShaderProgram.ShaderModuleData("resources/shaders/scene.frag", GL_FRAGMENT_SHADER)),
                        new ArrayList<>(),
                        new Vector4f(0.98f, 0.84f, 0.39f, 1.0f), new ArrayList<>(),
        ...
        spheres.add(new Sphere
                (
                        Arrays.asList
                                (new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER), new ShaderProgram.ShaderModuleData("resources/shaders/scene.frag", GL_FRAGMENT_SHADER)),
                        new ArrayList<>(),
                        new Vector4f(0.5f, 0.5f, 0.5f, 1.0f), new ArrayList<>(),
        ...
        spheres.add(new Sphere
                (
                        Arrays.asList
                                (new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER), new ShaderProgram.ShaderModuleData("resources/shaders/scene.frag", GL_FRAGMENT_SHADER)),
                        new ArrayList<>(),
                        new Vector4f(1.0f, 0.45f, 0.09f, 0.0f), new ArrayList<>(),
